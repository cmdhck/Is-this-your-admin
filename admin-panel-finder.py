...
▒█░░░ █░░█ █░▀░█ █▄▄▀ █▄▄█ █░░█ █▀▀ ▒█▀▀█ █▄▄█ █░░ █▀▄ █▀▀ █▄▄▀ 
▒█▄▄█ ▀▀▀▀ ▀░░░▀ ▀░▀▀ ▀░░▀ ▀▀▀░ ▀▀▀ ▒█░▒█ ▀░░▀ ▀▀▀ ▀░▀ ▀▀▀ ▀░▀▀                             
  github page : https://github.com/cmdhck
''')
	def slowprint(s):
		for c in s + '\n' :
			sys.stdout.write(c)
...
''')
	...
	print("                                                                       ")
	url = input("\033[94m [+] CMD Wants You To Enter Target Website : ")
	...
	def slowprint(f):
		for c in f + '\n' :
			...
			sys.stdout.flush()
			time.sleep(10. / 100)
	slowprint('''\033[91m [+] CMD Is On Progress... Feel Free To Press Ctrl+C At Any Point To Abort... ''')
	time.sleep(2)
